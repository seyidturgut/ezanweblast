...
export class TranslationService {
  ...
  private TR = {
    ...
    footer: {
      ...
      address_title: 'Adres',
      address_text: 'Maviay Yazılım Donanım Danışmanlık Hizmetleri Elektronik Özel Eğitim Sanayi ve Tic. Ltd. Şti.<br><br>Kocaeli Üniversitesi Teknopark Kampüsü<br>TÜRKİYE',
  ...
  private EN = {
    ...
    footer: {
      ...
      address_text: 'Maviay Software Hardware Consulting Services Electronic Special Education Industry and Trade Ltd. Co.<br><br>Kocaeli University Technopark Campus<br>TURKEY',
  ...
  private AR = {
    ...
    footer: {
      ...
      address_text: 'مافي آي للبرمجيات والاستشارات<br><br>حرم تكنوبارك جامعة كوجالي<br>تركيا',
  ...
  private DE = {
    ...
    footer: {
      ...
      address_text: 'Maviay Software Hardware Consulting Services Electronic Special Education Industry and Trade Ltd. Co.<br><br>Kocaeli Universität Technopark Campus<br>TÜRKEI',
  ...
  private FR = {
    ...
    footer: {
      ...
      address_title: 'Adresse',
      address_text: 'Maviay Software Hardware Consulting Services Electronic Special Education Industry and Trade Ltd. Co.<br><br>Université de Kocaeli Campus Technopark<br>TURQUIE',
